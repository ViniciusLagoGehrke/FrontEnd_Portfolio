...
In a take-home tech challenge, I was asked to develop a webapp and one of the prerequisites was that they could run and test the webapp even without knowing which version of Node it was used.
